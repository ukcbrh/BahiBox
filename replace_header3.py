...
new_header = """        {/* Header */}
        <header className="z-10 sticky top-0 pt-12 bg-slate-600 dark:bg-slate-950">
          <div className="bg-white dark:bg-slate-900 px-4 pt-5 pb-4 shadow-sm rounded-t-3xl rounded-b-3xl">
            <div className="flex items-start justify-between mb-4 mt-2">
              <div className="flex items-start gap-2">
                ...
                <div className="flex flex-col">
                  <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white leading-tight">अपना बहराइच APNA BAHRAICH</h1>
                  <div 
