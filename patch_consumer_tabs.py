...
def process_file(filename):
    ...
    target1 = """           <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-xl w-full">
            <button
    ...
    replacement1 = """           <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-xl w-full">
            <button
