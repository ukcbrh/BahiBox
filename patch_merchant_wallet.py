...
def process_file(filename):
  ...
  const handleWithdrawRequest = async (e: React.FormEvent) => {"""
    ...
    # 3. Tab buttons
    tabs_target = """          <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-xl w-full max-w-sm mx-auto lg:max-w-none">
            <button
    ...
    tabs_replacement = """          <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-xl w-full max-w-sm mx-auto lg:max-w-none">
            <button
